...
class AuthService {
  ...
  async createNewUser(data) {
    ...
    if (resp) {
      throw new AppError(false, "User Already Exists", 400);
    } else {
      ...
      if (newUser) {
        ...
        throw new AppError(false, "New User Could Not Created, Please Try Again.", 500);
      }
    }
  }
  ...
  async login(data) {
    ...
    if (resp) {
      ...
      throw new AppError(false, "Password Not Matched", 401);
       }
    } else {
